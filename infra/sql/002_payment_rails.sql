CREATE TABLE IF NOT EXISTS payment_intents (
  ...
  method TEXT NOT NULL CHECK (method IN ('UPI','CARD','CRYPTO')),
  ...
  status TEXT NOT NULL CHECK (status IN ('CREATED','PENDING','PROCESSING','COMPLETED','FAILED','CANCELED','EXPIRED','REQUIRES_ACTION')),
